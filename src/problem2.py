...
class Triangle(object):
    ...
    def area(self):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        self.distance1 = self.a.distance_from(self.b)
        self.distance2 = self.b.distance_from(self.c)
        self.distance3 = self.c.distance_from(self.a)

        s = (1 / 2) * (self.distance1 + self.distance2 + self.distance3)
        area = math.sqrt(s * (s - self.distance1) * (s - self.distance2) * (s - self.distance3))
        return area
